...
const AgentPublishCard = ({ card }) => {
  const navigate = useNavigate();

  return (
    <div
      className="flex flex-col items-start r-card cursor-pointer bg-white rounded-xl shadow-lg"
      onClick={() => navigate(`../AgentPublished/${card.id}`)}
    >
      {/* Image with overlay */}
...
export default AgentPublishCard;
