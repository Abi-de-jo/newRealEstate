...
const LandCard = ({ card }) => {
  ...
  const handleLikeClick = (e) => {
    e.stopPropagation(); // Prevent paSale onClick
  ...
  // Render only if the property type is "Sale"
  if (card.propertyType !== "Land") {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-72 overflow-hidden group">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transpaSale"></div>
