...
import PuffLoader from "react-spinners/PuffLoader";
 import AdminAgentDraftCard from "../../adminAgentDraftCard/adminAgentDraftCard";
const AdminAgentDraft = () => {
    ...
    <div className="wrapper">
      <div className="flexColCenter paddings innerWidth properties-container">
        <div className="paddings flexCenter properties mt-11">
           {data.map((card, i) => (
            <AdminAgentDraftCard card={card} key={i} />  
          ))}
        </div>
      </div>
    </div>
...
export default AdminAgentDraft;
